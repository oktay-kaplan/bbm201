...
public:
    ...
    void setSenderMAC(const std::string& newSenderMAC) {
        sender_MAC_address = newSenderMAC;
    }

    void setReceiverMAC(const std::string& newReceiverMAC) {
        receiver_MAC_address = newReceiverMAC;
    }
