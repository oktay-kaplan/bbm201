...
public:
    ...
    string receiver_ID;
    string message_data;
    string current_sender_ID;

    // Set sender MAC address
    void setCurrentSenderID(const std::string& newSenderID) {
        current_sender_ID = newSenderID;
    }

    // Set receiver MAC address
    void setReceiverID(const std::string& newReceiverID) {
